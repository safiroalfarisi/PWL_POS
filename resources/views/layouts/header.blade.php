<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            <img src="{{ asset('adminlte/dist/img/' . Auth::user()->username . '.png') }}" class="img-size-32 img-circle mr-2" alt="">
              <span class="d-none d-sm-inline-block">{{ Auth::user()->username }}</span>
          </a>
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <div class="dropdown-item">
                  <div class="media">
                    <img src="{{ asset('adminlte/dist/img/' . Auth::user()->username . '.png') }}" class="img-size-50 img-circle mr-3" alt="">
                      <div class="media-body">
                          <h3 class="dropdown-item-title">
                              {{ Auth::user()->username }}
                          </h3>
