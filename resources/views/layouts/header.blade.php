<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <img src="{{ asset('Adminlte/dist/img/'.Auth::user()->username.'.png') }}?{{ time() }}"
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item dropdown-footer" data-toggle="modal" data-target="#changeImageModal">
...
<div class="modal fade" id="changeImageModal" tabindex="-1" role="dialog" aria-labelledby="changeImageModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('/welcome/updateProfileImage') }}" method="POST" id="changeImageForm"
                  name="changeImageForm" enctype="multipart/form-data">
                @csrf
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status) {
                        ...
                        $('img[src*="{{ Auth::user()->username }}"]').each(function () {
                            $(this).attr('src', $(this).attr('src').split('?')[0] + '?' + Date.now());
                        });
                    } else {
