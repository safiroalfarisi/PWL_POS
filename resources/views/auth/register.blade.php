        ...
        $(document).ready(function () {
            $('#form-register').validate({
                rules: {
                    ...
                    nama: { required: true, nama: true },
                    password: { required: true },
                    password_confirmation: { required: true, equalTo: "#password" },
                },
                messages: {
                    username: { required: "Please enter your username" },
                    nama: { required: "Please enter your nama", nama: "Please enter a valid nama" },
                    password: { required: "Please enter your password" },
                    password_confirmation: { required: "Please enter your password confirmation", equalTo: "Password confirmation does not match" },
                },
                errorElement: 'small',
